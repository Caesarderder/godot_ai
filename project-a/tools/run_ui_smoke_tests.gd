...
func _run_slg_shell_smoke(instance: Node, game_autoload: Node) -> void:
	...
	_ok(_tree_has_text(instance, "不使用分析 SDK") and _tree_has_text(instance, "0.13.4-faction-proof.1"), "help exposes local-data privacy and the running product version")

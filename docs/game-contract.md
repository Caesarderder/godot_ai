...
- handoff_allowed_fields: implementation_reference,status,deviation,last_updated
- handoff_blocking: false
- deviation: 2026-07-28 已完成型号专属碎片账本、重复图纸转换、按稀有度升星成本、免费阵营十连保证、S1 强度、研发/编队/UI/存档接线，并由 7-seed `run_post_30m_faction_tests.gd` 覆盖；同日补齐可从 durable receipt 与领域事实恢复的五阶段阵营目标链，并由 `run_post_30m_ui_journey_tests.gd` 证明真实主场景点击会定向到抽取型号的科技分支、空编队槽与同一角色升星。十连奖励与编队候选会在 844×390 自动进入视野，科技、候选、名册与升星反馈持续标记同一阵营核心。真人阵营认同和继续游玩意愿仍待验证，不能由自动测试宣称“好玩”。
- last_updated: 2026-07-28
- last_verified: 2026-07-28

...
确认 75 秒施工到点后无需切页即可验收、免费突破十连 claim-once、冲锋/装甲永久入列，以及
装甲前排/冲锋次位的两次真实编队命令。脚本保存首战、高墙、施工、十连和编队转折；重复技能卡
...
3. 主动建成研究所、完成免费突破十连并把装甲与冲锋编入反攻队；
...
- 独立新档首章 smoke：从 1-1 连续经历 1-4 首败恢复、研究所免费十连、反攻、工业投产、

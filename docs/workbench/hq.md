...
```validation #mobile-ui-player-learning-20260731
{
  ...
  "instructions": [
    "使用新存档或首次接触项目的参与者；主持人不得讲解界面。",
    "每个任务画面稳定后点击开始，参与者首次回答时逐字记录并点击对应计时。",
    "答案错误也照实记录；不要提醒正确图标、目标或操作路径。",
    "完成后记录误触、求助和遮挡等阻碍，再保存本次记录。"
  ],
  "participant_target": 5,
  "pass_threshold": 4,
  "run_id": "mobile_slg_ui_refresh_20260731",
  ...
  "tasks": [
    {
      ...
      "image": "project-a/artifacts/ui-title-844x390.png",
      "prompt": "马桶人设定是否明确、画面是否足够震撼、主页是否足够简洁？",
      "task_id": "title",
      "title": "标题界面"
    },
    {

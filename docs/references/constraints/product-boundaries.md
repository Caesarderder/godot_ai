...
- 当前新档只拥有 Gman并先建设研究所；1-2、1-3 首通分别固定获得冲锋与装甲图纸，研究完成后成为永久角色；其他永久角色通过
  战役与后续招募进度解锁。P0 需要证明三星、六座设施、三工业资源、五个首章关卡和一个 Boss
  的 20–30 分钟闭环。
- 工厂保留当前 5×5 有界设施选址，用于形成可见建设选择；不扩展道路、工人、人口或复杂物流。
- 下一阶段已确认加入行动任务、指挥官等级、免费战令、永久成就和游戏内招募券驱动的永久英雄招募。
- Gman 与通关必需职责保持主线确定性获得；信号招募解锁后才开放免费十连，招募用于扩展阵容与升星，不替代攻城。
...
- 把有界设施选址扩展为自由建造、复杂物流、多队大地图或传统重度 SLG；
...
- 自动推图、自动扫荡和离线战斗模拟；
- 图纸研发材料混池和双货币商业经济；
- 超出当前 5×5 有界设施选址的自由建造、道路、工人、人口和复杂物流；
- 随机装备词条、套装、转职和多层天赋；
- PvP、公会、联盟战、排行榜和云端社交；
- 真实支付和商业发布。

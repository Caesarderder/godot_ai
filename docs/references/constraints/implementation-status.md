...
- 同一 Chrome 旅程已继续跨过首败恢复链：玩家真实选择研究所、点击 3D 网格、确认建造，等待
  ...
  revision `1f036f1d11a7` 的完整新 profile 运行在 266.7 秒到达三人编队；存档证明研究所位于
  `[-2, 2]`、十连 claim-once、冲锋/装甲永久角色及 `troop_1/2` 精确引用，运行异常、意外
  console error 和网络失败均为 0。真实 1-4 反攻 CTA 到结算尚未通过，继续作为明确断点。

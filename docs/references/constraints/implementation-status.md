...
固定保证两个不同的新型号候选，并让两者分别获得足够完成2★的同型号专属碎片。结果页先要求玩家
比较评级、阵营和2★质变，再以 durable `choose_faction_core` 亲自锁定长期核心；选择前研发目标
...
成长后的 2★Lv2 均通过 2-4、2★Lv3 均通过 2-5；自爆2★的主目标与溅射倍率、保命下限已按新增
候选覆盖校准，同时仍保留1★后段成长墙。最新招募结果与核心选择由

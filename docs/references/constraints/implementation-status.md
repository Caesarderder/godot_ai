...
主 CTA 直接聚焦该永久角色，不再泛化为军团首页。`ui-faction-wall-debrief-844x390.png`
证明失败原因、无损承诺和精确升星按钮在 844×390 首屏同时可见。
...
证明 1/3、事实贡献与“第2场验证 · 2-2”CTA 在 844×390 首屏完整可见。
...
核心按钮同屏，`ui-faction-proof-complete-844x390.png` 证明 3/3、“基础打法已经站稳”、
核心真实贡献及唯一 2-4 压力测试 CTA 同屏。UI 旅程通过三次真实 durable 结算验证完整状态链。

...
**战斗问题：** 基础占线为第三章断讯十字口、传送和屏幕控制创造观察窗口。

**反馈与反制：** 屏幕面部、青色信号和近距攻击要可区分；目标消失时转火其他敌人，冲锋/音波均为
低门槛替代。

**优化规划：** 3-1同时引入断讯十字口，基础兵伤害应低于机制学习价值。若玩家在理解转火前被普通
攻击击倒则降攻；若断讯十字口不改变任何目标选择则延长机制时长而非加兵。

**边界：** 断讯十字口由关卡级 `_run_tv_mechanics()` 选择目标，不保证来自本单位。

...
- 当前连续证据：clean candidate `43f3e1d3ba79` / `0.13.54-visible-boss-growth-gate.1` 已由
  ...
  hero ID 未变且最终 `star = 2`；715.266 秒、1046 次技能触控期间三类 runtime/console/network
  错误均为 0。`browser-first-industrial-gift-claimed-844x390.png`、

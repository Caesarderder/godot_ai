...
| `project-a/game/scripts/platform/local_playtest_journal.gd` | platform-evidence | 显式 opt-in、白名单本地事件、256 条上限、首章 12 里程碑/分段耗时/断点、菜单与手动战斗停滞派生、报告导出与关闭删除 | present / Platform + Chrome smoke |

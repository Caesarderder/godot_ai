---
km_id: reference.skill-game-design-stage-game-design
km_type: reference
domain: game
status: active
last_verified: 2026-07-24
source_of_truth:
  - legacy:project-skills/game-design
validated_by:
...
canonical_technical_owner: game-design
source_skill: game-design
content_home: godot-game-design/references/stages/game-design/SKILL.md
...
用户请求与 `game-design` 直接相关，且本节点是当前任务所需的一到两个最小叶子之一时。

## 职责

- [读取完整保留内容](../../stages/game-design/SKILL.md)

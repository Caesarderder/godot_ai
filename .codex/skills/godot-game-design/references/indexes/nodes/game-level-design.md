---
km_id: reference.skill-game-design-system-game-level-design
km_type: reference
domain: game
status: active
last_verified: 2026-07-24
source_of_truth:
  - legacy:project-skills/game-level-design
validated_by:
...
canonical_technical_owner: game-level-design
source_skill: game-level-design
content_home: godot-game-design/references/systems/game-level-design/SKILL.md
...
用户请求与 `game-level-design` 直接相关，且本节点是当前任务所需的一到两个最小叶子之一时。

## 职责

- [读取完整保留内容](../../systems/game-level-design/SKILL.md)

---
km_id: reference.skill-qa-release-practice-gd-agentic-testing-patterns
km_type: reference
domain: game
status: active
...
canonical_technical_owner: gd-agentic-testing-patterns
source_skill: gd-agentic-web-runtime
content_home: godot-qa-release/references/gd-agentic-testing-patterns.md
...
用户请求与 `gd-agentic-testing-patterns` 直接相关，且本节点是当前任务所需的一到两个最小叶子之一时。

## 职责

- [读取完整保留内容](../../gd-agentic-testing-patterns.md)

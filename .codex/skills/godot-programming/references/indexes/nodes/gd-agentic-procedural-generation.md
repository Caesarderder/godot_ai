---
km_id: reference.skill-programming-system-gd-agentic-procedural-generation
km_type: reference
domain: game
status: active
...
canonical_technical_owner: gd-agentic-procedural-generation
source_skill: gd-agentic-3d-systems
content_home: godot-programming/references/gd-agentic-procedural-generation.md
...
用户请求与 `gd-agentic-procedural-generation` 直接相关，且本节点是当前任务所需的一到两个最小叶子之一时。

## 职责

- [读取完整保留内容](../../gd-agentic-procedural-generation.md)

---
km_id: reference.skill-art-system-gd-agentic-3d-world-building
km_type: reference
domain: game
status: active
...
canonical_technical_owner: gd-agentic-3d-world-building
source_skill: gd-agentic-3d-systems
content_home: godot-art/references/gd-agentic-3d-world-building.md
...
用户请求与 `gd-agentic-3d-world-building` 直接相关，且本节点是当前任务所需的一到两个最小叶子之一时。

## 职责

- [读取完整保留内容](../../gd-agentic-3d-world-building.md)

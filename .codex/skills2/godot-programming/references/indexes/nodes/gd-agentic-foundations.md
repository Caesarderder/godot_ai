---
km_id: reference.skill-programming-provenance-gd-agentic-foundations
km_type: reference
domain: game
status: active
...
canonical_technical_owner: gd-agentic-foundations
source_skill: gd-agentic-foundations
content_home: godot-programming/references/provenance/raw/gd-agentic-foundations/SKILL.md
...
- [读取完整保留内容](../../provenance/raw/gd-agentic-foundations/SKILL.md)
